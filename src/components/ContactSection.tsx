    ...
    <section id="contact" className="py-10 sm:py-14 md:py-20 lg:py-24 bg-secondary/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-12">
          ...
          >
            <h3 className="font-heading text-base sm:text-lg md:text-xl lg:text-2xl text-tedx-red uppercase mb-2">Questions?</h3>
            <p className="font-heading text-xs sm:text-sm text-foreground uppercase mb-4 sm:mb-6">We're Here To Help!</p>
            <div className="space-y-4 text-muted-foreground">
              <p className="font-heading text-xs sm:text-sm uppercase">Contact Us</p>
              {isError ? (
