    ...
    <section id="about" className="py-10 sm:py-14 md:py-20 lg:py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 lg:gap-16 items-center mb-16 md:mb-24">
          ...
          >
            <motion.h2
              className="font-heading about-heading-hero text-white uppercase tracking-wider mb-3 sm:mb-4 md:mb-6 lg:mb-8"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 lg:gap-16 items-center mb-16 md:mb-24">
          ...
          >
            <motion.h2
              className="font-heading text-5xl sm:text-6xl md:text-8xl lg:text-9xl xl:text-[100px] 2xl:text-[160px] text-white uppercase tracking-wider mb-3 sm:mb-4 md:mb-6 lg:mb-8"
              whileInView={{ opacity: [0, 1], y: [30, 0] }}
              viewport={{ once: true }}
            >
              {sections[1].title}
        ...
        >
          <motion.h2
            className="font-heading text-4xl sm:text-5xl md:text-7xl lg:text-8xl xl:text-9xl 2xl:text-[120px] text-white uppercase tracking-wider mb-3 sm:mb-4 md:mb-6 lg:mb-8"
            whileInView={{ opacity: [0, 1], y: [30, 0] }}
            viewport={{ once: true }}
          >
            {sections[2].title}
